...
import principal.mf3w8aa
import principal.mf5w12aa
import principal.mf5w4aa
import principal.mf5w8aa
import principal.mf7w4aa
import self_CM.mf3w7ba
import self_CM.mf7w3ba

if __name__ == "__main__":
    # principal.mf11w2aa.find_zeroes()
    # principal.mf5w4aa.find_zeroes()
    # principal.mf5w8aa.find_zeroes() 
    # principal.mf7w4aa.find_zeroes()
    # self_CM.mf3w7ba.find_zeroes()
    ...
    # self_CM.mf7w3ba.filter_delta_minus()
    # generic.mf13w2ea.filter_even()
    # generic.mf13w2ea.filter_odd()
    ...
    # self_CM.mf3w7ba.plot_odd()
    # self_CM.mf7w3ba.plot_even()
